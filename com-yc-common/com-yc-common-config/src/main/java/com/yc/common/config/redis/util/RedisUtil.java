package com.yc.common.config.redis.util;
...
public class RedisUtil {
    public static final long HOURS = 3600; //一个小时的秒数
    public static final long DAY = 86400; //一天的秒数
    public static final long MONTH = 2592000; //一个月的秒数
