package com.yc.common.ds.aspect;

import com.alibaba.druid.pool.DruidDataSource;
import com.yc.common.ds.handler.DynamicDataSourceHandler;
import com.yc.common.ds.properties.DynamicDataSourceProperties;
import com.yc.common.ds.annotation.DynamicDataSource;
 ...
 * @Description:   运行时连接指定数据源.各增加逻辑判断读写分离
...
public class DynamicDataSourceAspect {
     ...
     * Pointcut 切入点
     */
    @Pointcut("@annotation(com.yc.common.ds.annotation.DynamicDataSource)")
...
//        }
    ...
    private boolean switchDataSource(String key) {
        ...
        if (!DynamicDataSourceHandler.dataSourcesMap.containsKey(key)) {//如果没有此数据源配置则加入并刷新targetDataSource
            DynamicDataSourceHandler.dataSourcesMap.put(key, druidDataSource);
        }
        DynamicDataSourceHandler.setDataSource(key);
        return true;
    }
